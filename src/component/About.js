  ...
  render() {
    return (
      ...
      <div className="about-color">
          <h1>About</h1>
          My name is David Calderwood and I am from Portland, Oregon. I attendend <a target="_blank" rel="noopener noreferrer" color="blue" href="https://heliotraining.com/">Helio Training</a>. I graduated with proficiency as a Web Developer.<br/>
